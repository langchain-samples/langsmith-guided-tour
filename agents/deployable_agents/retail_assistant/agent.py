"""Deployable retail shopping & service assistant.

Customer-facing orchestrator that routes each request to one of seven
specialized subagents. All tools are mocked — canned demo data, no network.
Demonstrates:
- AGENTS.md for agent identity and instructions
- Skills for on-demand capabilities (product-comparison, order-summary)
- Seven specialized subagents the orchestrator routes to
